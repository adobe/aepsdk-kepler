...
export const AEPSDK = {
    ...
    start(prams?: SDKParams): void {
        ...
        configuration.onRegister(new ExtensionContainerImpl(eventHub, configuration.name, sharedStateManager), serviceLookup);
        edge.onRegister(new ExtensionContainerImpl(eventHub, edge.name, sharedStateManager), serviceLookup);
