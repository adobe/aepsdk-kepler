...
describe('test ExtensionContainerImpl class', () => {
    ...
    test('test ExtensionContainer.createXDMSharedState() - null event', () => {
        ...
        expect(sharedStateManager.updateSharedState).toBeCalledWith("extension_name", 0, state, SharedStateStatus.SET);
    ...
    test('test ExtensionContainer.createXDMSharedState()', () => {
        ...
        expect(sharedStateManager.updateSharedState).toBeCalledTimes(1);
        expect(sharedStateManager.updateSharedState).toBeCalledWith("extension_name", eventId, state, SharedStateStatus.SET);
    ...
    test('test ExtensionContainer.createPendingXDMSharedState()', () => {
        ...
        promise.then((resolver) => {
            ...
            expect(sharedStateManager.updateSharedState).lastCalledWith("extension_name", eventId, sharedState, SharedStateStatus.SET);
