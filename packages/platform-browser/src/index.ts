...
import { Log, registerService } from '@adobe/js-aepcore';
import { LOG_EXTENSION } from "./Constants";

const LOG_TAG = "registerPlatformService-browser";

function registerPlatformService(): void {
  Log.debug(LOG_EXTENSION, LOG_TAG, "registerPlatformService() - Registering KeplerDataStore");
  registerService("dataStore", new SessionDataStore());
}
